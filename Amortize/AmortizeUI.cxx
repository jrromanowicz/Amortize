...
void AmortizeUI::cb_menuButton_i(Fl_Menu_Button* o, void*) {
  paymentPeriod = (PaymentPeriod)(o->value()) ;
...
void AmortizeUI::cb_Amortize_i(Fl_Button*, void* v) {
  ((AmortizeUI *)v)->doAmortization((AmortizeUI*)v) ;
}
void AmortizeUI::cb_Amortize(Fl_Button* o, void* v) {
  ((AmortizeUI*)(o->parent()->user_data()))->cb_Amortize_i(o,v);
}

void AmortizeUI::cb_saveButton_i(Fl_Button*, void* v) {
  ((AmortizeUI *)v)->doSave((AmortizeUI*)v) ;
}
void AmortizeUI::cb_saveButton(Fl_Button* o, void* v) {
  ((AmortizeUI*)(o->parent()->user_data()))->cb_saveButton_i(o,v);
}

void AmortizeUI::cb_Col1Color_i(Fl_Button*, void*) {
  Fl_Color colColor = fl_show_colormap(amortizeTable->columnColor(1)) ;
amortizeTable->columnColor(1, colColor) ;
amortizeTable->redraw() ;
}
void AmortizeUI::cb_Col1Color(Fl_Button* o, void* v) {
  ((AmortizeUI*)(o->parent()->parent()->user_data()))->cb_Col1Color_i(o,v);
}

void AmortizeUI::cb_Col2Color_i(Fl_Button*, void*) {
  Fl_Color colColor = fl_show_colormap(amortizeTable->columnColor(2)) ;
amortizeTable->columnColor(2, colColor) ;
amortizeTable->redraw() ;
}
void AmortizeUI::cb_Col2Color(Fl_Button* o, void* v) {
  ((AmortizeUI*)(o->parent()->parent()->user_data()))->cb_Col2Color_i(o,v);
}

void AmortizeUI::cb_Col3Color_i(Fl_Button*, void*) {
  Fl_Color colColor = fl_show_colormap(amortizeTable->columnColor(3)) ;
amortizeTable->columnColor(3, colColor) ;
amortizeTable->redraw() ;
}
void AmortizeUI::cb_Col3Color(Fl_Button* o, void* v) {
  ((AmortizeUI*)(o->parent()->parent()->user_data()))->cb_Col3Color_i(o,v);
}

void AmortizeUI::cb_Col4Color_i(Fl_Button*, void*) {
  Fl_Color colColor = fl_show_colormap(amortizeTable->columnColor(4)) ;
amortizeTable->columnColor(4, colColor) ;
amortizeTable->redraw() ;
}
void AmortizeUI::cb_Col4Color(Fl_Button* o, void* v) {
  ((AmortizeUI*)(o->parent()->parent()->user_data()))->cb_Col4Color_i(o,v);
}

// listen for an escape key event, in case the user's setting up cell values
...
AmortizeUI::AmortizeUI(void (*doAmortize)(AmortizeUI *),
      void(*saveFunc)(AmortizeUI *), const char * title)
  : Fl_Window(658, 520, title)
{
  principalAmount = interestRate = fixedPayment = percentPayment
      = minimumPayment = numPayments = 0;
  paymentPeriod = InvalidPeriod;
  loanType = InvalidLoan;
  ...
  when(FL_WHEN_RELEASE);
    { results = new Fl_Text_Display(5, 325, 225, 190);
      results->labelfont(4);
      results->labelcolor((Fl_Color)176);
      results->textfont(4);
      results->align(FL_ALIGN_TOP_LEFT);
      results->wrap_mode(1, 26) ; //word wrap on
      results->buffer(resultText) ;
    } // Fl_Text_Display* results
    { amortizeTable = new AmortizeTable(235, 26, 415, 490);
    ...
    { saveButton = new Fl_Button(130, 290, 84, 25, "Save to CSV");
...
AmortizeUI::PaymentPeriod AmortizeUI::getPaymentPeriod(void) {
  return paymentPeriod ;
}

AmortizeUI::LoanType AmortizeUI::getLoanType(void) {
  return loanType ;
}
...
AmortizeTable * AmortizeUI::getPaymentTable(void) {
  return amortizeTable ;
}

void AmortizeUI::hideSaveButton() {
  saveButton->hide() ;
}

void AmortizeUI::showSaveButton() {
  saveButton->show() ;
}
